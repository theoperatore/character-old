  ...
  render : function() {
    ...
    return (
      <div className="settings-tear">
        ...
        <Input bsStyle={this.state['str'] === "" ? null : validstr} type="text" label="Strength" value={this.state['str']} onChange={this.handleChange.bind(this, "str")} placeholder={this.props.character.getIn(['charAbilities', 'str', 'score'])}/>
        <Input bsStyle={this.state['dex'] === "" ? null : validdex} type="text" label="Dexterity" value={this.state['dex']} onChange={this.handleChange.bind(this, "dex")} placeholder={this.props.character.getIn(['charAbilities', 'dex', 'score'])}/>
        <Input bsStyle={this.state['con'] === "" ? null : validcon} type="text" label="Constitution" value={this.state['con']} onChange={this.handleChange.bind(this, "con")} placeholder={this.props.character.getIn(['charAbilities', 'con', 'score'])}/>
        <Input bsStyle={this.state['int'] === "" ? null : validint} type="text" label="Intelligence" value={this.state['int']} onChange={this.handleChange.bind(this, "int")} placeholder={this.props.character.getIn(['charAbilities', 'int', 'score'])}/>
        <Input bsStyle={this.state['wis'] === "" ? null : validwis} type="text" label="Wisdom" value={this.state['wis']} onChange={this.handleChange.bind(this, "wis")} placeholder={this.props.character.getIn(['charAbilities', 'wis', 'score'])}/>
        <Input bsStyle={this.state['cha'] === "" ? null : validcha} type="text" label="Charisma" value={this.state['cha']} onChange={this.handleChange.bind(this, "cha")} placeholder={this.props.character.getIn(['charAbilities', 'cha', 'score'])}/>
        <Input bsStyle={this.state.prof === "" ? null : validprof} type="text" label="Proficiency Bonus" value={this.state.prof} onChange={this.handleChange.bind(this, "prof")} placeholder={this.props.character.getIn(['charProficiencyBonus', 'score'])}/>
        <ButtonToolbar>
