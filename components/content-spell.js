    ...
    return (
      <div className="container-fluid">
        ...
        <Accordion defaultActiveKey="">
          <Panel eventKey={0} header="Cantrips"></Panel>
          <Panel eventKey={1} header="1st Level">
            <div className="slots">
              <p>Spell Slots</p>
              <Grid fluid>
                <Row>
          ...
          <Panel eventKey={2} header="2nd Level">
            <div className="slots">
              <p>Spell Slots</p>
              <Grid fluid>
                <Row>
          ...
          <Panel eventKey={3} header="3rd Level"></Panel>
          <Panel eventKey={4} header="4th Level"></Panel>
          <Panel eventKey={5} header="5th Level"></Panel>
          <Panel eventKey={6} header="6th Level"></Panel>
          <Panel eventKey={7} header="7th Level"></Panel>
          <Panel eventKey={8} header="8th Level"></Panel>
          <Panel eventKey={9} header="9th Level"></Panel>
        </Accordion>
